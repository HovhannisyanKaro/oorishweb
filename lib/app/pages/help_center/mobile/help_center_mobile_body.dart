...
class HelpCenterMobileBody extends StatefulWidget {
  const HelpCenterMobileBody({super.key});

  @override
  State<HelpCenterMobileBody> createState() => _HelpCenterMobileBodyState();
}

class _HelpCenterMobileBodyState extends State<HelpCenterMobileBody> {
  @override
      ...
      childBuilder: (context, constraints) {
        ...
        return Column(
          children: [
            ...
            Text('HELP CENTER', style: Theme.of(context).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.bold, color: context.themeExt.onSurface.withOpacity(0.5))),
            Text('How can we help?', style: Theme.of(context).textTheme.headlineLarge?.copyWith(fontWeight: FontWeight.bold)),
            const SizedBox(height: 64),
            _grid(itemWidth: width),
            const SizedBox(height: 128),
            Text('Contact Support', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
            Text('We’re sorry that our FAQ did not answer your question. Send us a message to oorish2024@gmail.com! We’re looking forward to reading your email and we will answer it as quickly as we can.',
